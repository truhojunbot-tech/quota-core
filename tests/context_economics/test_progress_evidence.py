...
from quota_core.context_economics import emit_contract, recommend_task_policy
...
class ProgressEvidenceTests(unittest.TestCase):
    ...
    def test_emit_contract_cites_both_rationales(self) -> None:
        ...
        for name, rows in (("unchanged", UNCHANGED), ("moved", MOVED)):
            ...
            contract, _sha = emit_contract(self.dir / f"{name}.json", [db], produced_at="2026-09-23T00:00:00+00:00")
